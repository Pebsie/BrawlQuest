...
uiImg["Quest"] = love.graphics.newImage("img/ui/quest.png")
uiImg["Active Quest"] = love.graphics.newImage("img/ui/activequest.png")
uiImg["Blueprint"] = love.graphics.newImage("img/items/blueprint.png")