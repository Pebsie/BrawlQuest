...
--  filestring = '<html><head><style>image-rendering: pixelated;</style></head><center><h1>'..name..'</h1><img src="http://brawlquest.com/dl/img/human/Legendary Padding.png" width="256" height="256"><br /><h2>Level 10</h2><h2>Gear</h2><img src="http://brawlquest.com/dl/img/items/weapons/'..pl.wep[name]..'.png" width="32" height="32">'..pl.wep[name]..' - <em>'..item.val[pl.wep[name]]..'+'..pl.str[name]..' <b>ATK</b></em><br /><img src="http://brawlquest.com/dl/img/human/'..pl.arm[name]..'.png">'..pl.arm[name].." - <em>"..item.val[pl.arm[name]]..' <b>DEF</b></em><br /><h2>Stats</h2><b>Playtime: </b>'..round(pl.playtime[name]/60, 0).."m<br /><b>Kills: </b>"..pl.kills[name].."<br /><b>Deaths: </b>"..pl.deaths[name].."<br /><b>Distance travelled: </b>"..pl.distance[name].."m<br /><b>Last login:</b> "..dayString.."</html>"
  filestring = "<h1>This service is currently being remade!</h1>"
