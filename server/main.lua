...
function love.load()
  ...
  givePlayerItem("pebsie","Rend",1)
  givePlayerItem("pebsie","Potent Healing Potion",1)
  givePlayerItem("pebsie","Potent Energising Potion",1)
  givePlayerItem("pebsie","Legendary Padding",1)
  givePlayerItem("pebsie","Exotic Masterwork Steel Armour",1)
