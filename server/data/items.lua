...
item.img[ti] = "img/empty.png" item.title[ti] = ti
...
item.img["Blueprint"] = "img/items/blueprint.png"
...
item.img[ti] = "img/human/armour/legend/head.png" item.title[ti] = ti
...
item.img[ti] = "img/human/armour/legend/chest.png" item.title[ti] = ti
...
item.lvl[ti] = 14
item.price[ti] = "20,Iron,10,String,10,Mana,1,Old World Crystal"
item.img[ti] = "img/human/armour/legend/legs.png" item.title[ti] = ti
...
item.img[ti] = "img/human/armour/wood/head.png" item.title[ti] = ti
...
item.img[ti] = "img/human/armour/wood/chest.png" item.title[ti] = ti
...
item.img[ti] = "img/human/armour/wood/legs.png" item.title[ti] = ti
...
item.img[ti] = "img/human/armour/iron/head.png" item.title[ti] = ti
...
item.img[ti] = "img/human/armour/iron/chest.png" item.title[ti] = ti
...
item.img[ti] = "img/human/armour/iron/legs.png" item.title[ti] = ti
...
item.img[ti] = "img/human/armour/guardian/head.png" item.title[ti] = ti
...
item.img[ti] = "img/human/armour/guardian/chest.png" item.title[ti] = ti
...
item.lvl[ti] = 1
item.price[ti] = "0,Gold"
item.img[ti] = "img/world/objects/Boat.png" item.title[ti] = ti
...
item.lvl[ti] = 1
item.price[ti] = "0,Gold"
item.img[ti] = "img/human/base.png" item.title[ti] = ti
...
item.lvl[ti] = 1
item.price[ti] = "0,Gold"
item.img[ti] = "img/human/Adventurer.png" item.title[ti] = ti
...
item.img[ti] = "img/human/Clean Adventurer.png" item.title[ti] = ti
...
item.img[ti] = "img/human/Clothed Adventurer.png" item.title[ti] = ti
...
item.img[ti] = "img/human/Warrior.png" item.title[ti] = ti
...
item.img[ti] = "img/human/Guardian.png" item.title[ti] = ti
...
item.img[ti] = "img/human/Legend.png" item.title[ti] = ti
...
item.img[ti] = "img/items/weapons/Short Sword.png" item.title[ti] = ti
...
item.img[ti] = "img/items/weapons/Long Sword.png" item.title[ti] = ti
...
item.img[ti] = "img/items/weapons/Guardians Blade.png" item.title[ti] = ti
...
item.img[ti] = "img/items/weapons/Legendary Blade.png" item.title[ti] = ti
...
item.img[ti] = "img/items/consumables/Healing Potion.png" item.title[ti] = ti
...
item.img[ti] = "img/items/scrolls/Recovery.png" item.title[ti] = ti
...
item.lvl[ti] = 10
item.price[ti] = "10,Mana"
item.img[ti] = "img/items/scrolls/Ground Slam.png" item.title[ti] = ti
  ...
  item.lvl[ti] = 10
  item.price[ti] = "10,Mana"
  item.img[ti] = "img/items/scrolls/Enrage.png" item.title[ti] = ti
  ...
  item.lvl[ti] = 10
  item.price[ti] = "10,Mana"
  item.img[ti] = "img/items/scrolls/Flash of Light.png" item.title[ti] = ti
  ...
  item.img[ti] = "img/items/scrolls/Polymorph.png" item.title[ti] = ti
  ...
  item.img[ti] = "img/items/scrolls/Summon Snakes.png" item.title[ti] = ti

--buddy (Wolf, Snake, Beholder, Baby Bat, Earth Elementling, Fire Elementling, Dragonling)
buddy = {}
buddy["Baby Bat"] = "img/pet/Baby Bat.png"
buddy["Beholder"] = "img/pet/Beholder.png"
buddy["Beholdling"] = "img/pet/Beholdling.png"
buddy["Chicken"] = "img/pet/Chicken.png"
buddy["Dog"] = "img/pet/Dog.png"
buddy["Dragonling"] = "img/pet/Dragonling.png"
buddy["Earth Elementling"] = "img/pet/Earth Elementling.png"
buddy["Fire Elementling"] = "img/pet/Fire Elementling.png"
buddy["Scorpion"] = "img/pet/Scorpion.png"
buddy["Sheep"] = "img/pet/Sheep.png"
buddy["Snake"] = "img/pet/Snake.png"
buddy["Water Elementling"] = "img/pet/Water Elementling.png"
buddy["Protector"] = "img/pet/Protector.png"
buddy["Fly"] = "img/pet/Fly.png"
buddy["Horse"] = "img/pet/Horse.png"
buddy["Silver Dragonling"] = "img/pet/Silver Dragonling.png"
buddy["Spirit of Death"] = "img/pet/Spirit Of Death.png"
...
--special
  ...
  item.lvl[ti] = 10
  item.price[ti] = "0,Gold"
  item.img[ti] = "img/items/letter.png" item.title[ti] = ti
  ...
  item.lvl[ti] = "??"
  item.price[ti] = "0,Gold"
  item.img[ti] = "img/items/key.png" item.title[ti] = ti
  ...
  item.img[ti] = "img/items/Adver Ring.png" item.title[ti] = ti
  ...
  item.lvl[ti] = 1
  item.price[ti] = "0,Gold"
  item.img[ti] = "img/items/gold.png" item.title[ti] = ti
  ...
  item.img[ti] = "img/world/objects/Crystal.png" item.title[ti] = ti
  ...
  item.img[ti] = "img/items/Quia.png" item.title[ti] = ti
  ...
  item.lvl[ti] = 1
  item.price[ti] = "1,Gold"
  item.img[ti] = "img/items/reagent/Wood.png" item.title[ti] = ti
  ...
  item.lvl[ti] = 1
  item.price[ti] = "1,Gold"
  item.img[ti] = "img/items/reagent/Stone.png" item.title[ti] = ti
  ...
  item.lvl[ti] = 1
  item.price[ti] = "1,Gold"
  item.img[ti] = "img/items/reagent/String.png" item.title[ti] = ti
