function loadMusic()
  ...
  music.world[1] = love.audio.newSource("sound/music/loop.ogg", "stream")
...
--  music.world[5] = love.audio.newSource("sound/music/world5.mp3", "stream")
  ...
  music.fight[1] = love.audio.newSource("sound/music/drone.mp3", "stream")

  music.curPlay = music.title[love.math.random(1, #music.title)]
  music.curPlay:setVolume(0.1)
  music.curPlay:setLooping(true)
